...
Continuous thermostat setpoint monitoring and correction (Thermostat setpoint correction) Copyright (c) 2024, The Regents of the University of California,
...
The license can be found [here](https://github.com/LBNL-ETA/thermostat_setpoint_correction/blob/main/License.txt). 
